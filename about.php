...
<div class="conor_tm_wrapper_all">
    <div class="wrapper_inner">
        ...
        <div class="conor_tm_about_wrap">
            <div class="conor_tm_main_titles_wrap">
                <div class="container">
                    <div class="inner_wrap">
                        ...
                        <div class="breadcrumbs">
                            <p><a href="index.php">Home</a> <span>/</span> <span>About Me</span></p>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="conor_tm_universal_box_wrap">
            <div class="bg_wrap">
                <div class="overlay_image about jarallax" data-speed="0"></div>
                <div class="overlay_video"></div>
                <div class="overlay_color about"></div>
            </div>
            <div class="content about">
                <div class="shape"></div>
            </div>
        </div>
        <div class="conor_tm_section" data-aos="fade-up" data-aos-duration="800">
        ...
        <div class="conor_tm_section" data-aos="fade-up" data-aos-duration="800">
            <div class="conor_tm_partners_wrap">
                <div class="container">
                    <div class="inner_wrap">
                        <ul class="partner-list" style="display: flex; justify-content: space-around; align-items: center; list-style: none; padding: 0;">
                            <li style="font-size: 24px; font-weight: bold; color: #555; transition: all 0.3s ease;"><i class="xcon-facebook"></i> TechCorp</li>
                            <li style="font-size: 24px; font-weight: bold; color: #555; transition: all 0.3s ease;"><i class="xcon-twitter"></i> Studio Web</li>
                            <li style="font-size: 24px; font-weight: bold; color: #555; transition: all 0.3s ease;"><i class="xcon-instagram"></i> CreateInc</li>
                            <li style="font-size: 24px; font-weight: bold; color: #555; transition: all 0.3s ease;"><i class="xcon-linkedin"></i> Innovators</li>
                        </ul>
                    </div>
                </div>
            </div>
        </div>
        <div class="conor_tm_section" data-aos="fade-up" data-aos-duration="1000">
            <div class="conor_tm_counter_wrapper_all">
                <div class="container">
                    <div class="wrapper_inner">
                        <div class="conor_tm_counter_wrap">
                            <ul class="conor_tm_counter_list conor_tm_miniboxes">
                                <li>
                                    <div class="inner conor_tm_minibox">
                                        <h3><span><span class="conor_tm_counter" data-from="0" data-to="2222"
                                ...
                                <li>
                                    <div class="inner conor_tm_minibox">
                                        <h3><span><span class="conor_tm_counter" data-from="0" data-to="333"
                                ...
                                <li>
                                    <div class="inner conor_tm_minibox">
                                        <h3><span><span class="conor_tm_counter" data-from="0" data-to="8888"
                                                        data-speed="3000">0</span></span></h3>
                                ...
                                <li>
                                    <div class="inner conor_tm_minibox">
                                        <h3><span><span class="conor_tm_counter" data-from="0" data-to="777"
                                                        data-speed="3000">0</span>+</span></h3>
