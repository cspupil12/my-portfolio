...
function conor_tm_contact_form(){
	...
	jQuery(".contact_form #send_message").on('click', function(e){
		...
		if(name===''||email===''||message===''){
			...
			var mailtoUrl = "mailto:jaspreet.singh.para@gmail.com" +
				"?subject=" + encodeURIComponent(subject) +
				"&body=" + encodeURIComponent(body);
			
			// Trigger browser redirection to mail service/app
			window.location.href = mailtoUrl;
			
			// Show success banner and reset form fields
...
jQuery(document).ready(function(){
    if(jQuery('#tsparticles').length){
        tsParticles.load("tsparticles", {
            ...
            particles: {
                color: { value: "#e3872d" },
                links: { color: "#e3872d", distance: 150, enable: true, opacity: 0.5, width: 1 },
